...
import static com.wulis.common.constant.GlobalConstant.AUTHOR;
...
public class MybatisPlusGeneratorConfig {
    ...
    public AutoGenerator mybatisPlusGenerator(String[] tableNames, String moduleName) {
        ...
        // 项目工程包名
        String packageName = "com.wulis.provider";
    ...
    private StrategyConfig getStrategyConfig(String[] tableNames, String moduleName) {
        return new StrategyConfig()
            ...
            // 继承BaseEntity
            .setSuperEntityClass("com.wulis.common.model.entity.BaseEntity")
            // 继承BaseController
            .setSuperControllerClass("com.wulis.common.support.BaseController")
            // 继承BaseService
            .setSuperServiceClass("com.wulis.common.support.BaseService")
            // 继承BaseServiceImpl
            .setSuperServiceImplClass("com.wulis.common.support.BaseServiceImpl")
            // 继承BaseMapper
            .setSuperMapperClass("com.wulis.common.support.BaseMapper");
    }
