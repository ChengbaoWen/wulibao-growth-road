package com.wulibao.provider.test.design.pattern.structural.adapter;

import com.wulibao.provider.test.design.pattern.structural.adapter.player.VideoMediaPlayer;
